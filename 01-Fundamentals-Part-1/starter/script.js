...
let enoughScore = false;
if (avgScoreDolphins >= 100 || avgScoreKoalas >= 100) {
  enoughScore = true;
}

if (avgScoreDolphins > avgScoreKoalas && enoughScore) {
  console.log("Dolphins win!");
} else if (avgScoreDolphins < avgScoreKoalas && enoughScore) {
...
const age = 23;
// age >= 18
//   ? console.log("I like to drink wine 🍷") // if true
//   : console.log("I like to drink water 💧"); // else

const drink = age >= 18 ? "wine 🍷" : "water 💧"; // if age >= 18 -> drink = 'wine' else drink = 'water'
console.log(drink);

// let drink2; //doing the same thing with if
// if (age >= 18) {
//   drink2 = "wine 🍷";
// } else {
//   drink2 = "water 💧";
